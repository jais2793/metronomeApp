function Timer(callback, timeInterval,swingPercentage, options) {
    ...
    this.round = () => {
        ...
        // Calculate swing delay based on swing percentage (assuming 8th note swing)
        let swingDelay = (this.timeInterval / 2) * swingPercentage / 100;
        ...
        this.timeout = setTimeout(this.round, this.timeInterval - drift + swingDelay);
    }
}
